 ...
 */
export const syncTextFromSentences = <ThrowOnError extends boolean = false>(options: Options<SyncTextFromSentencesData, ThrowOnError>) => (options.client ?? client).post<SyncTextFromSentencesResponses, SyncTextFromSentencesErrors, ThrowOnError>({ url: '/api/v1/texts/{id}/sync', ...options });

/**
 * Render a printable HTML view of the text with sentence-level breakdown
 */
export const printText = <ThrowOnError extends boolean = false>(options: Options<PrintTextData, ThrowOnError>) => (options.client ?? client).get<PrintTextResponses, PrintTextErrors, ThrowOnError>({ url: '/api/v1/texts/{id}/print', ...options });
 ...
 */
export const generateInsight = <ThrowOnError extends boolean = false>(options: Options<GenerateInsightData, ThrowOnError>) => (options.client ?? client).post<GenerateInsightResponses, GenerateInsightErrors, ThrowOnError>({
 ...
 */
export const getAnalyticsOverview = <ThrowOnError extends boolean = false>(options?: Options<GetAnalyticsOverviewData, ThrowOnError>) => (options?.client ?? client).get<GetAnalyticsOverviewResponses, unknown, ThrowOnError>({ url: '/api/v1/analytics/overview', ...options });
