 ...
 */
export const getTrainingStats = <ThrowOnError extends boolean = false>(options?: Options<GetTrainingStatsData, ThrowOnError>) => (options?.client ?? client).get<GetTrainingStatsResponses, unknown, ThrowOnError>({ url: '/api/v1/training/stats', ...options });
