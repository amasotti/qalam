...
- [ ] 14.0 `[F]` Re-run `pnpm generate:types` if backend `documentation.yaml` has changed since M13; commit updated `types.gen.ts` before writing any typed store/component code
